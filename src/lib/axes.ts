...
export const AXES: AxisDef[] = [
  ...
  },
  {
    ...
    lowPole: "Monochrome",
    highPole: "Multicolor",
    description: "Number of hues — a restrained one/two-color palette vs a multi-hue one.",
    briefLow: "a restrained monochrome palette",
    briefHigh: "a rich multicolor palette",
  },
  {
    id: "gradients",
    label: "Fills",
    lowPole: "Flat",
    highPole: "Gradient",
    description: "Surface fills — flat solid colors vs gradient blends.",
    briefLow: "flat, solid color fills",
    briefHigh: "gradient fills and blends",
  },
  {
    id: "cornerSoftness",
    label: "Corners",
  ...
  },
  {
    ...
    lowPole: "Light",
    highPole: "Heavy",
    description: "Font weight — light, airy weights vs heavy, bold weights.",
    briefLow: "light, airy font weights",
    briefHigh: "heavy, bold font weights",
  },
  {
    id: "letterCase",
    label: "Casing",
    lowPole: "Sentence",
    highPole: "Uppercase",
    description: "Letter casing — sentence/mixed case vs uppercase-heavy treatment.",
    briefLow: "sentence-case text",
    briefHigh: "uppercase-heavy text",
  },
  {
    id: "geometry",
    label: "Geometry",
